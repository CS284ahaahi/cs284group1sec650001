...
public class UserFrame extends JFrame {
	...
	public UserFrame(User user){
		...
		JPanel info = new JPanel(new GridLayout(7,7));
                info.add(userIDlb);info.add(userID);
                info.add(userNamelb);info.add(userName);
                info.add(firstNamelb);info.add(firstName);
                info.add(lastNamelb);info.add(lastName);
                info.add(emaillb);info.add(email);
                info.add(ranklb);info.add(rank);
                info.add(statuslb);info.add(status);
